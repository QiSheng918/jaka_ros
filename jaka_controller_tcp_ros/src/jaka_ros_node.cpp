...
std::string robot_IP = "192.168.51.188";
...
private:
	...
	ros::Publisher robot_pub,joint_state_pub;
...
void jaka_ros_node::CommandCallback(const universal_msgs::Command::ConstPtr &msg)
{
	...
	}else if (msg->type == 10)
	{
		...
		std::cout<<"Servo Enable Command!"<<std::endl;
		robotclient.ServoEnable(msg->servo_enable_flag);
		return ;
	}else if(msg->type == 12){
